...
// ---- ShaderMaterial ----
// We will use ShaderMaterial, not RawShaderMaterial
// -----------------------------------------------------------

// it will work without you adding vertex of fragment shader
// defaults will be applied, and in case of fragment shader,
// plane will be colored in red
// This isn't possible with RawShaderMaterial where we need to
// to specify vertex shader in order everything to work
