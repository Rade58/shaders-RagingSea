...
// ----------  ----------
// after playing with gui we picked color values for
// depthColor and surfaceColor (as you remeber we used these values as uniforms)
// we just defined new final values inside guiParameters
// object
// ------------------------------------
// ------------ gui -------------------
