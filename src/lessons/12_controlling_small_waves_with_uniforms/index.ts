...
// ---- controlling small waves with uniforms ----

// we will set up uniforms to controll small waves
// wich as you know are result of 3d perlin noise

// we defined bunch of uniforms prefixed with "uSmallWaves"
// and we will be able to change them with gui
...
if (canvas) {
  ...
  const waterMaterial = new THREE.ShaderMaterial({
    ...
    uniforms: {
      ...
      // here are new uniforms
      uSmallWavesAmplitude: {
        value: 0.15,
      },
