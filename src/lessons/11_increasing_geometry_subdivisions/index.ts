...
// ---- More subdivisions in our geometry ----

// we can't see the smallest waves so we will
// increase the subdivisions to 512 x 512

// we can also increase perlin noise we defined
// in vertex shader inside for loop
// but don't do it too much
// because it can be bad for performacise
// for example our loop is looping two times
// you can increase it to 3 by setting 4.0 (we start from 1.0
// since we use i inside our math)
// -------------------------------------------
// ------------ gui -------------------
